...
double calibrate() {
    ...
    // With 80% padding on lower frequency.
...
double discretization(double frequency_out) {
   ...
   static double frequency_table[25] = {220.00, 233.08, 246.94, 261.63, 277.18, 293.66, 311.13, 329.63, 349.23, 369.99, 392.00, 415.30,
                                 440.00, 466.16, 493.88, 523.25, 554.37, 587.33, 622.25, 659.25, 698.46, 739.99, 783.99, 830.61,
                                 880.00};
   //int n = 37;
   int n = 25;
